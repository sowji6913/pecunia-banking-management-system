...
public class AccountLoanServiceImpl implements AccountLoanService {
	...
	public Loan loanRequest(int accountNumber, double amount, int tenure, int creditScore) throws AccountExcepetion {
	   ...
	   String amount1=String.valueOf(amount1);
	   if(!amount1.matches("[0-9]{10000000}"))
		   throw new AccountException("amount out of range ");
	   return accountLoanDao.loanRequest(accountNumber, amount1, tenure, creditScore);
